...
版本规避：若版本低于PHP5.3，则删除本框架所有页面开头“namespace”的行、删除本框架中所有的“use Alopay”开头的行，删除“Alopay\Core”，修改Autoloader::NAMESPACE_PREFIX=''，修改curl.lib.php的\Exception为Exception即可。
...
函数详解：
    ...
    一、被动给用户发送消息。
        ...
        2、使用命名空间：use Alopay\Core\ResponsePassive;
    ...
    二、AccessToken授权。
        ...
        2、使用命名空间：use Alopay\Core\AccessToken;
    ...
    四、用户及用户组管理。
        ...
        2、使用命名空间：use Alopay\Core\UserManage;
    ...
    五、网页授权。
        ...
        2、使用命名空间：use Alopay\Core\WeChatOAuth;
    ...
    六、多媒体上传下载
        ...
        2、使用命名空间：use Alopay\Core\Media;
    ...
    八、高级群发接口
        ...
        2、使用命名空间：use Alopay\Core\AdvancedBroadcast;
    ...
    九、多客服接口
        ...
        2、使用命名空间：use Alopay\Core\CustomService;
    ...
    十、智能接口
        ...
        2、使用命名空间：use Alopay\Core\IntelligentInterface;
    ...
    十一、推广支持
        ...
        2、使用命名空间：use Alopay\Core\Popularize;
    ...
    十二、模板消息接口
        ...
        2、使用命名空间：use Alopay\Core\TemplateMessage;
    ...
    十四、自动回复
            ...
            2、使用命名空间：use Alopay\Core\AutoReply;
...
实例示范：
    ...
    一、通过网页授权获得用户信息
        ...
        <?php
            use Alopay\Core\WeChatOAuth;
            use Alopay\Core\UserManage;
    ...
    四、推送模板消息
        ...
        代码：
            ...
            //$topcolor 顶部颜色，可以为空。默认是红色
            \Alopay\Core\TemplateMessage::sendTemplateMessage($data, $touser, $templateId, $url, $topcolor='#FF0000');
    ...
    五、添加自定义菜单
        ...
        代码：
            ...
            $result = \Alopay\Core\Menu::setMenu($menuList);
    ...
    六、页面展示二维码
        ...
        代码：
            ...
            $ticket = \Alopay\Core\Popularize::createTicket(1, 1800, 1);
            $ticket = $ticket['ticket'];
            $qrcode = \Alopay\Core\Popularize::getQrcode($ticket);
            echo $qrcode;
