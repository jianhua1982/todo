...
var cordova = {
    ...
    callbackFromNative: function(callbackId, success, status, args, keepCallback) {
        ...
        //console.log('>>> callbackFromNative = ' + callbackId + '   status = ' + status + '   args = ' + JSON.stringify(args));
...
exports.load = function(callback) {
    ...
    /*
        1. No need to load cordova_plugins.js for our hybrid solution.
        2. Convenient for later dynamic load.
     */
